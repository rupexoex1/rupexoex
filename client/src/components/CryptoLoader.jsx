  ...
  return (
    <div className="min-h-screen w-full bg-neutral-950 text-neutral-200 flex items-center justify-center p-6">
      ...
      <div className="relative flex flex-col items-center justify-center">
        ...
        <div
          className="h-28 w-28 rounded-xl border border-cyan-400/30 bg-neutral-900/80 backdrop-blur flex items-center justify-center relative z-10"
